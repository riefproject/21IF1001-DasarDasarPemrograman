...
/*
Diedit sebagai pemenuhan tugas oleh:
Arief F-sa Wijaya (riefproject)
*/
...
int main()
{
	...
	for (;;)
	{
		...
		SetBln(12, &D2);
		SetThn(1972, &D2);
		printf("\nSetelah perintah Set dilakukan, maka D2 bernilai : ");
		PrintObj(D2);
		BacaDate(&D3);
		printf("\nSetelah perintah BacaDate(&D3), maka D3 bernilai : ");
		PrintObj(D3);
